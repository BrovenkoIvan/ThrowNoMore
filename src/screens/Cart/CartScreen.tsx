   ...
   <>
     ...
     {items.length ?
       <View style={styles.amountContainer}>
         <Text style={{ fontSize: 22, color: Colors.MAIN, textAlign: 'right', paddingBottom: 8 }}>
           You will saving {items.length} products: {totalGr} gr. and {(totalPrice * 0.3).toFixed(2)} kr
         </Text>
         <Text style={{ fontSize: 24, fontWeight: '600' }}>Total: {totalPrice.toFixed(2)} kr</Text>
       </View>
       : null
     }
   </>
